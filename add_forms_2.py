...
for file_path in files_to_update:
    try:
        ...
        new_content = content.replace('</p><a href="contact.html" class="btn-dark">', '</p>\n' + form_html + '\n<a href="contact.html" class="btn-dark">')
        
        # Only add script if we actually modified the file, or if it doesn't have it
        if new_content != content and 'form-handler.js' not in new_content:
